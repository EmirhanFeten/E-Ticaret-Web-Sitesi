<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="iletisim.aspx.cs" Inherits="E_TicaretWebSitesi.iletisim" %>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-5">
                    <asp:TextBox ID="TextBox1" style="width:100%" placeholder="Adınız" class="form-control" runat="server"></asp:TextBox>   
