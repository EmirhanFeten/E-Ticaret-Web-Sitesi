<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="E_TicaretWebSitesi.Admin.adminLogin" %>
    ...
    <div class="container-fluid">
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                ...
                <asp:Button ID="Button1" class="btn btn-primary py-3 w-100 mb-4" runat="server" Text="Giriş" OnClick="Button1_Click" />
                </div>
            </div>
        </div>
    </div>
