<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="E_TicaretWebSitesi.login" %>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-7 col-lg-7">
	            ...
	            <div class="form-group">
                    <asp:Button ID="Button1" class=" form-control btn btn-primary rounded submit px-3" runat="server" Text="Giriş Yap" OnClick="Button1_Click"   />
	            </div>
	          ...
	          <p class="text-center">Hesabınız Yok Mu? <a data-toggle="tab" href="register.aspx">Kaydol</a></p>
              <p class="text-center"><a data-toggle="tab" href="index.aspx"> Giriş Yapmadan Devam Etmek İçin</a></p>                            
	        </div>
	      </div>
			</div>
		</div>
